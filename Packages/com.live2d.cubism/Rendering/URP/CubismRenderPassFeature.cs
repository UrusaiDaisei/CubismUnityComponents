...
namespace Live2D.Cubism.Rendering.URP
{
    ...
    public sealed class CubismRenderPassFeature : ScriptableRendererFeature
    {
        ...
        /// </summary>
        private sealed class CubismRenderPass : ScriptableRenderPass
        {
            /// <summary>
            ...
            /// </summary>
            private sealed class PassData : ICubismRenderPassData
            {
                /// <summary>
                ...
                /// </summary>
                public UniversalCameraData CameraData { get; set; }
                ...
                /// </summary>
                public TextureHandle MaskTextureHandle { get; set; }

                /// <summary>
                /// Texture handle for the camera render target.
                /// </summary>
                public TextureHandle CameraTextureHandle { get; set; }

                /// <summary>
                /// Texture handle for the camera depth buffer.
                /// </summary>
                public TextureHandle CameraDepthTextureHandle { get; set; }

                /// <summary>
                /// Texture handle for common rendering operations.
                /// </summary>
                public TextureHandle CommonRenderingTextureHandle { get; set; }

                /// <summary>
                /// Texture handle for temporary rendering operations.
                /// </summary>
                public TextureHandle CommonTemporaryTextureHandle { get; set; }
            }
