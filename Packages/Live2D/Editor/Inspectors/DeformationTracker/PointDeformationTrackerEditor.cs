...
namespace Live2D.Cubism.Editor.Inspectors
{
    ...
    public sealed partial class PointDeformationTrackerEditor : UnityEditor.Editor
    {
        ...
        /// </remarks>
        private static PointDeformationTracker.VertexReference[] FindVerticesInRadius(
            Vector2 position,
            float radius,
            CubismDrawable[] includedDrawables)
        {
            ...
            if (includedDrawables == null || includedDrawables.Length == 0)
                return new PointDeformationTracker.VertexReference[0];
        ...
        /// </summary>
        private static PointDeformationTracker.VertexReference[] SelectOptimalVertexSubset(
            float radius,
            IEnumerable<(int drawableIndex, int vertexIndex, float distance)> verticeCandidates)
        {
            ...
            return bestVertices.Select(d => new PointDeformationTracker.VertexReference
            {
        ...
        private static void CalculateVertexWeights(
            Vector2 position,
            PointDeformationTracker.VertexReference[] vertexReferences,
            CubismDrawable[] includedDrawables)
        {
