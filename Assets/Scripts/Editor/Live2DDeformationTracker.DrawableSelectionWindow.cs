...
{
    /// <summary>
    /// Window for selecting which drawables to include in the Live2DDeformationTracker.
    /// </summary>
    private sealed class DrawableSelectionWindow : EditorWindow
    {
        #region UI Constants

        private const string UXML_PATH = "Assets/Scripts/Editor/Live2DDeformationTrackerDrawableSelectionWindow.uxml";
        private const string USS_PATH = "Assets/Scripts/Editor/Live2DDeformationTrackerDrawableSelectionWindow.uss";
        ...
        /// </summary>
        /// <param name="tracker">The Live2DDeformationTracker to update</param>
        /// <param name="allDrawables">All available drawables in the model</param>
        ...
        private void LoadUIAssets()
        {
            ...
            if (visualTree == null)
            {
                throw new System.Exception($"Could not load UXML file at path: {UXML_PATH}");
            }
            ...
            if (styleSheet == null)
            {
                throw new System.Exception($"Could not load USS file at path: {USS_PATH}");
            }
